...
void Game::addEvent(string event, string gameName)
{
    ofstream myfile;
...
void Game::addGeneralStats(std::map<string, string> map)
{
...
void Game::addTeamStats(std::map<string, string> map, string team)
{
    std::map<string, string>::iterator it = map.begin();
    while (it != map.end())
    {
...
void Game::addreports(string discription, string header)
{
    reports[header] = discription;
}
string Game::toString(string file)
{
    string ans = "";
    ans += gameName + "\n";
    ans += "Game stats: \n";
...
string Game::toStringHashMap(std::map<string, string> h)
{
    string message = "";
...
string Game::toStringReports(std::map<string, string> h)
{
    string message = "";
    std::map<string, string>::iterator it = h.begin();
    while (it != h.end())
